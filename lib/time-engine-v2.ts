...
// Cache Busting: 2026-02-11 16:55
// Cache Busting: 2026-02-11 16:55
...
export function calculateToThereOnTime(startDate: string | Date, timeOffsetHours: number = 0) {
    ...
    const currentDay = Math.floor(toThereOnDaysPassed) + 1;
    const progress = toThereOnDaysPassed - Math.floor(toThereOnDaysPassed);
...
// Wrapper for timeline route compatibility
